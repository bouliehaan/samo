...
import { ALBUM_ARTIST_TABLE_COLUMNS, ALBUM_TABLE_COLUMNS, GENRE_TABLE_COLUMNS, pickGridRows, pickTableColumns, PLAYLIST_SONG_TABLE_COLUMNS, PLAYLIST_TABLE_COLUMNS, SONG_TABLE_COLUMNS, } from '/@/renderer/components/item-list/item-table-list/default-columns';
...
import { ArtistItem, ArtistReleaseTypeItem, BarAlign, DiscordDisplayType, DiscordLinkType, GenreTarget, HomeFeatureStyle, HomeItem, PlayerItem, PlayerbarSliderType, PlaylistTarget, } from './schemas';
...
const getPlatformDefaultWindowBarStyle = () => {
    if (utils?.isWindows()) {
...
const platformDefaultWindowBarStyle = getPlatformDefaultWindowBarStyle();
...
export const initialStateWithEnv = mergeWith(cloneDeep(initialState), getEnvSettingsOverrides());
