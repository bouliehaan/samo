...
import { computePlayerData, getPlaybackInputs, getQueueFromState, getQueueOrderFromState, isFirstTrackInQueueFromState, isLastTrackInQueueFromState, playbackInputsEqual, } from './player-derived';
import { PlayerRepeat, PlayerShuffle, PlayerStatus } from '/@/shared/types/types';
const song = (id, uniqueId) => ({
    _uniqueId: uniqueId,
    id,
    name: id,
});
...
describe('getQueueFromState', () => {
    it('groups items when groupBy is provided', () => {
        const s0 = { ...song('0', 'u0'), album: 'Alpha' };
        const s1 = { ...song('1', 'u1'), album: 'Alpha' };
        const s2 = { ...song('2', 'u2'), album: 'Beta' };
