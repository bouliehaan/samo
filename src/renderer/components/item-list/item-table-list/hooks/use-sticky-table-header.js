...
export const useStickyTableHeader = ({ containerRef, enabled, headerRef, mainGridRef, pinnedLeftColumnRef, pinnedRightColumnRef, stickyHeaderMainRef, }) => {
    ...
    const topMargin = windowBarStyle === Platform.WINDOWS || windowBarStyle === Platform.MACOS
        ? '-130px'
        : '-100px';
    ...
    useEffect(() => {
        ...
        const mainGrid = mainGridRef.current.childNodes[0];
