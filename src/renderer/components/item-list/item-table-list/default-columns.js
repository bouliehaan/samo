...
export const PLAYLIST_SONG_TABLE_COLUMNS = SONG_TABLE_COLUMNS;
...
export const ALBUM_ARTIST_TABLE_COLUMNS = [
    {
        align: 'center',
        autoSize: false,
        isEnabled: true,
...
export const pickTableColumns = (options) => {
    const { alignCenterColumns = [], alignLeftColumns = [], alignRightColumns = [], autoSizeColumns = [], columns, columnWidths = {}, enabledColumns, pickColumns = [], pinnedLeftColumns = [], pinnedRightColumns = [], } = options;
    const columnsToPick = [];
...
export const pickGridRows = (options) => {
