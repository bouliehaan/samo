...
import { Album, AlbumArtist, Artist, Folder, Genre, LibraryItem, Playlist, Song } from '/@/shared/types/domain-types';
...
export interface ItemControls {
    ...
    onFavorite?: ({ index, internalState, item, itemType, }: DefaultItemControlProps & {
        favorite: boolean;
    }) => void;
    onMore?: ({ index, internalState, item, itemType }: DefaultItemControlProps) => void;
    onPlay?: ({ index, internalState, item, itemType, playType, }: DefaultItemControlProps & {
        playType: Play;
    }) => void;
    onRating?: ({ index, internalState, item, itemType, rating, }: DefaultItemControlProps & {
        rating: number;
    }) => void;
}
...
export type ItemListItem = Album | AlbumArtist | Artist | Folder | Genre | Playlist | Song | undefined;
