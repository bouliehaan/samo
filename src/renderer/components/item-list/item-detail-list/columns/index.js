...
export function getDetailListCellComponent(columnId) {
    const Component = COLUMN_MAP[columnId];
    if (Component) {
        return Component;
    }
    return (props) => React.createElement(DefaultColumn, {
        columnId: props.columnId ?? columnId,
        song: props.song,
    });
}
