...
export const FavoriteColumn = ({ controls, internalState, isMutatingFavorite, onFavoriteClick, song, }) => {
    ...
    return (_jsx(ActionIcon, { disabled: isMutating, icon: "favorite", iconProps: {
