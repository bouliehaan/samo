...
export const GenreListInfiniteGrid = ({ gap = 'md', itemsPerPage = 100, itemsPerRow, query = {
    ...
    return (_jsx(ItemGridList, { data: loadedItems, dataVersion: dataVersion, enableMultiSelect: enableGridMultiSelect, gap: gap, getItem: getItem, getItemIndex: getItemIndex, initialTop: {
            to: scrollOffset ?? 0,
            type: 'offset',
        }, itemCount: itemCount, itemsPerRow: itemsPerRow, itemType: LibraryItem.GENRE, onRangeChanged: onRangeChanged, onScrollEnd: handleOnScrollEnd, rows: rows, size: size }));
};
