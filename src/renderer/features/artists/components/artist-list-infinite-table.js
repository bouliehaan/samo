...
export const ArtistListInfiniteTable = ({ autoFitColumns = false, columns, enableAlternateRowColors = false, enableHeader = true, enableHorizontalBorders = false, enableRowHoverHighlight = true, enableSelection = true, enableVerticalBorders = false, itemsPerPage = 100, query = {
    ...
    return (_jsx(ItemTableList, { autoFitColumns: autoFitColumns, CellComponent: ItemTableListColumn, columns: columns, data: loadedItems, enableAlternateRowColors: enableAlternateRowColors, enableExpansion: false, enableHeader: enableHeader, enableHorizontalBorders: enableHorizontalBorders, enableRowHoverHighlight: enableRowHoverHighlight, enableSelection: enableSelection, enableVerticalBorders: enableVerticalBorders, getItem: getItem, getItemIndex: getItemIndex, initialTop: {
            to: scrollOffset ?? 0,
            type: 'offset',
        }, itemCount: itemCount, itemType: LibraryItem.ARTIST, onColumnReordered: handleColumnReordered, onColumnResized: handleColumnResized, onRangeChanged: onRangeChanged, onScrollEnd: handleOnScrollEnd, size: size }));
};
