...
export const useRemote = () => {
    ...
    useEffect(() => {
        ...
        remote
            ?.updateSetting(remoteSettings.enabled, remoteSettings.port, remoteSettings.username, remoteSettings.password)
            .catch((error) => {
    ...
    useEffect(() => {
        ...
        remote.requestPosition((_e, data) => {
        ...
        remote.requestFavorite((_e, data) => {
