...
export const RadioListContent = () => {
    ...
    const { sortBy } = useSortByFilter(RadioListSort.NAME, ItemListKey.RADIO);
    ...
    return (_jsx(Suspense, { fallback: _jsx(Spinner, { container: true }), children: _jsx(ScrollArea, { children: _jsx(Stack, { p: "md", children: _jsx(RadioListItems, { data: filteredAndSortedRadioStations }) }) }) }));
};
