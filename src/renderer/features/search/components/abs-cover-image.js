 ...
 */
export const AbsCoverImage = ({ alt, fallbackIcon, itemId }) => {
    ...
    if (coverQuery.data) {
        return (_jsx("img", { alt: alt, loading: "lazy", src: coverQuery.data, style: {
                display: 'block',
                height: '100%',
                objectFit: 'cover',
    ...
    return _jsx(Icon, { icon: fallbackIcon, size: "lg" });
};
