...
export const SongListPaginatedGrid = ({ gap = 'md', itemsPerPage = 100, itemsPerRow, query = {
    ...
    return (_jsx(ItemListWithPagination, { currentPage: currentPage, itemsPerPage: itemsPerPage, onChange: onChange, pageCount: pageCount, totalItemCount: totalItemCount, children: _jsx(ItemGridList, { currentPage: currentPage, data: data || [], enableMultiSelect: enableGridMultiSelect, gap: gap, itemsPerRow: itemsPerRow, itemType: LibraryItem.SONG, rows: rows, size: size }) }));
};
