...
export const SongListHeaderFilters = ({ toggleGenreTarget }) => {
    ...
    const hasActiveFilters = useMemo(() => {
        ...
        return Boolean(isFilterValueSet(query[FILTER_KEYS.SONG._CUSTOM]) ||
    ...
    return (_jsxs(Flex, { justify: "space-between", children: [_jsxs(Group, { gap: "sm", w: "100%", children: [toggleGenreTarget && (_jsxs(_Fragment, { children: [_jsx(Button, { leftSection: _jsx(Icon, { icon: "arrowLeftRight" }), onClick: handleToggleGenreTarget, variant: "subtle", children: choice }), _jsx(Divider, { orientation: "vertical" })] })), _jsx(ListSortByDropdown, { defaultSortByValue: SongListSort.NAME, itemType: LibraryItem.SONG, listKey: pageKey }), _jsx(Divider, { orientation: "vertical" }), _jsx(ListSortOrderToggleButton, { defaultSortOrder: SortOrder.ASC, listKey: pageKey }), _jsx(ListFiltersModal, { isActive: hasActiveFilters, itemType: LibraryItem.SONG }), _jsx(ListRefreshButton, { listKey: pageKey })] }), _jsxs(Group, { gap: "sm", wrap: "nowrap", children: [_jsx(ListDisplayTypeToggleButton, { listKey: ItemListKey.SONG }), _jsx(ListConfigMenu, { displayTypes: SONG_DISPLAY_TYPES, listKey: ItemListKey.SONG, tableColumnsData: SONG_TABLE_COLUMNS })] })] }));
};
