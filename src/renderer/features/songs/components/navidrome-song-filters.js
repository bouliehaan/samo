...
export const NavidromeSongFilters = ({ disableArtistFilter, disableGenreFilter, }) => {
    const { t } = useTranslation();
    const server = useCurrentServer();
    const serverId = server.id;
    const { query, setArtistIds, setCustom, setFavorite, setGenreId, setMaxYear, setMinYear } = useSongListFilters();
    ...
    return (_jsxs(Stack, { px: "md", py: "md", children: [_jsxs(Stack, { gap: "xs", children: [_jsx(Text, { size: "sm", weight: 500, children: t('filter.isFavorited', { postProcess: 'sentenceCase' }) }), _jsx(SegmentedControl, { data: segmentedControlData, onChange: (value) => {
                        ...
                        }, size: "sm", value: booleanToSegmentValue(query.favorite), w: "100%" })] }), !disableArtistFilter && (_jsxs(_Fragment, { children: [_jsx(Divider, { my: "md" }), _jsx(VirtualMultiSelect, { displayCountType: "song", height: 300, label: artistFilterLabel, onChange: handleArtistChange, options: selectableAlbumArtists, RowComponent: ArtistMultiSelectRow, singleSelect: artistSelectMode === 'single', value: selectedArtistIds })] })), !disableGenreFilter && (_jsx(VirtualMultiSelect, { displayCountType: "song", height: 220, isLoading: genreListQuery.isFetching, label: genreFilterLabel, onChange: handleGenreChange, options: genreList, RowComponent: GenreMultiSelectRow, singleSelect: genreSelectMode === 'single', value: selectedGenreIds })), _jsx(NumberInput, { hideControls: false, label: t('common.year', { postProcess: 'titleCase' }), max: 5000, min: 0, onChange: (e) => debouncedHandleYearFilter(e), value: query.minYear ?? undefined }), _jsx(TagFilters, { query: query, setCustom: setCustom, type: LibraryItem.SONG })] }));
};
