...
const SongListRoute = () => {
    ...
    return (_jsx(AnimatedPage, { children: _jsxs(ListContext.Provider, { value: providerValue, children: [_jsx(SongListHeader, {}), _jsx(ListWithSidebarContainer, { children: _jsx(SongListContent, {}) })] }) }));
};
const SongListRouteWithBoundary = () => {
    return (_jsx(PageErrorBoundary, { children: _jsx(SongListRoute, {}) }));
};
