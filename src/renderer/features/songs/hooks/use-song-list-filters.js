...
import { parseArrayParam, parseBooleanParam, parseCustomFiltersParam, parseIntParam, setJsonSearchParam, setMultipleSearchParams, setSearchParam, } from '/@/renderer/utils/query-params';
import { runInUrlTransition } from '/@/renderer/utils/url-transition';
import { SongListSort, SortOrder } from '/@/shared/types/domain-types';
import { ItemListKey } from '/@/shared/types/types';
export const useSongListFilters = (listKey) => {
    const resolvedListKey = listKey ?? ItemListKey.SONG;
    const { sortBy } = useSortByFilter(SongListSort.NAME, resolvedListKey);
    ...
    const setCustom = useCallback((value) => {
        runInUrlTransition(() => {
            setSearchParams((prev) => {
                ...
                let newValue = typeof value === 'function' ? value(currentCustom ?? null) : value;
