...
export const PageErrorBoundary = ({ children }) => {
    return (_jsx(ErrorBoundary, { FallbackComponent: PageErrorFallback, onError: (error, errorInfo) => {
