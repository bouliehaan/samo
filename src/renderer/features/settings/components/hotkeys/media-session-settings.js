...
export const MediaSessionSettings = memo(() => {
    ...
    function handleMediaSessionChange(e) {
    ...
    const mediaSessionOptions = [
        {
            control: (_jsx(Switch, { "aria-label": "Toggle media Session", checked: mediaSession, disabled: isLinux || !isDesktop || playbackType !== PlayerType.WEB, onChange: (e) => handleMediaSessionChange(e.currentTarget.checked) })),
    ...
    return _jsx(SettingsSection, { options: mediaSessionOptions });
});
