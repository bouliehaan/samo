...
import { DiscordDisplayType, DiscordLinkType, useDiscordSettings, useGeneralSettings, useSettingsStoreActions, } from '/@/renderer/store';
...
export const DiscordSettings = memo(() => {
    ...
    const discordOptions = [
        {
            control: (_jsx(Switch, { checked: settings.enabled, onChange: (e) => {
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(TextInput, { defaultValue: settings.clientId, onBlur: (e) => {
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(Switch, { checked: settings.showPaused, onChange: (e) => {
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(Switch, { checked: settings.showStateIcon, onChange: (e) => {
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(Switch, { checked: settings.showAsListening, onChange: (e) => {
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(Select, { "aria-label": t('setting.discordDisplayType'), clearable: false, data: [
                ...
                ], defaultValue: settings.displayType, onChange: (e) => {
                    if (!e)
                        return;
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(Select, { "aria-label": t('setting.discordLinkType'), clearable: false, data: [
                    {
                ...
                ], defaultValue: settings.linkType, onChange: (e) => {
                    if (!e)
                        return;
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(Switch, { checked: settings.showServerImage, onChange: (e) => {
                    setSettings({
                        discord: {
        ...
        {
            control: (_jsx(TextInput, { defaultValue: generalSettings.lastfmApiKey, onBlur: (e) => {
                    setSettings({
                        general: {
    ...
    return (_jsx(SettingsSection, { options: discordOptions, title: t('page.setting.discord', { postProcess: 'sentenceCase' }) }));
});
