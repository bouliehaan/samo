...
export const albumQueries = {
    ...
    list: (args) => {
        return queryOptions({
            ...
            queryKey: queryKeys.albums.list(args.serverId, args.query, args.query?.artistIds?.length === 1 ? args.query?.artistIds[0] : undefined),
            ...args.options,
        });
    },
    listCount: (args) => {
        return queryOptions({
            ...
            queryKey: queryKeys.albums.count(args.serverId, args.query, args.query?.artistIds?.length === 1 ? args.query?.artistIds[0] : undefined),
