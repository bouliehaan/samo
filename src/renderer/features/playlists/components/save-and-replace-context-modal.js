...
export const SaveAndReplaceContextModal = ({ innerProps, }) => {
    ...
    return (_jsx(ConfirmModal, { loading: updatePlaylistMutation.isPending, onConfirm: handleConfirm, children: _jsx(Text, { children: t('common.areYouSure', { postProcess: 'sentenceCase' }) }) }));
};
