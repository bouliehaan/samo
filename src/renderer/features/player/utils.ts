...
export const getAlbumSongsById = async (args: {
    ...
    fetchSongList(args.queryClient, args.serverId, {
        albumIds: args.id,
...
export const getGenreSongsById = async (args: {
    ...
    for (const genreId of id) {
        const res = await fetchSongList(queryClient, serverId, {
            genreIds: [genreId],
