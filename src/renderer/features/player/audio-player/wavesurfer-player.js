...
import { WaveSurferPlayerEngine, } from '/@/renderer/features/player/audio-player/engine/wavesurfer-player-engine';
import { usePlayerEvents } from '/@/renderer/features/player/audio-player/hooks/use-player-events';
import { useSongUrl } from '/@/renderer/features/player/audio-player/hooks/use-stream-url';
import { setClockAnchor, setClockPlaying, } from '/@/renderer/features/player/audio-player/playback-clock';
import { usePlaybackSettings, usePlayerActions, usePlayerData, usePlayerProperties, usePlayerVolumeState, } from '/@/renderer/store';
...
export function WaveSurferPlayer() {
    ...
    return (_jsx(WaveSurferPlayerEngine, { isMuted: isMuted, isTransitioning: Boolean(isTransitioning), onEndedPlayer1: handleOnEndedPlayer1, onEndedPlayer2: handleOnEndedPlayer2, onProgressPlayer1: onProgressPlayer1, onProgressPlayer2: onProgressPlayer2, playerNum: num, playerRef: playerRef, playerStatus: localPlayerStatus, speed: speed, src1: player1Url, src2: player2Url, volume: volume }));
}
function crossfadeHandler(args) {
    const { crossfadeDuration, currentPlayer, currentPlayerNum, currentTime, duration, hasNextSong, isTransitioning, nextPlayer, playerNum, setIsTransitioning, volume, } = args;
