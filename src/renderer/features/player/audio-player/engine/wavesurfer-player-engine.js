...
export const WaveSurferPlayerEngine = (props) => {
    const { isMuted, isTransitioning, onEndedPlayer1, onEndedPlayer2, onProgressPlayer1, onProgressPlayer2, playerNum, playerRef, playerStatus, speed, src1, src2, volume, } = props;
    ...
    return (_jsxs("div", { id: "wavesurfer-player-engine", style: { display: 'none' }, children: [Boolean(src1) && _jsx("div", { id: "wavesurfer-player-1", ref: container1Ref }), Boolean(src2) && _jsx("div", { id: "wavesurfer-player-2", ref: container2Ref })] }));
};
