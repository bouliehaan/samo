...
export const useMainPlayerListener = () => {
    ...
    const { decreaseVolume, increaseVolume, mediaAutoNext, mediaNext, mediaPause, mediaPlay, mediaPrevious, mediaSkipBackward, mediaSkipForward, mediaStop, mediaToggleMute, mediaTogglePlayPause, toggleRepeat, toggleShuffle, } = usePlayerActions();
    const handleMpvError = useCallback((message) => {
        toast.error({
            id: 'mpv-error',
            message,
    ...
    useEffect(() => {
        ...
        mpvPlayerListener.rendererError((_event, message) => {
...
export const MainPlayerListenerHook = () => {
    ...
    return _jsx(MainPlayerListenerHookInner, {});
};
