...
export const useSendScrobble = (options) => {
    const queryClient = useQueryClient();
    const lastScrobbledAlbumKeyRef = useRef('');
    return useMutation({
        mutationFn: (args) => {
        ...
        onSuccess: (_data, variables) => {
            ...
            if (variables.query.submission) {
                ...
                if (variables.query.albumId) {
                    ...
                    const isSameAlbumAsContext = isPlayingFromAlbum && currentAlbumId === variables.query.albumId;
