...
const artistInfo = z.object({
    artistInfo: z.object({
        ...
        musicBrainzId: z.string().optional(),
        similarArtist: z.array(z.object({
            albumCount: z.string(),
            artistImageUrl: z.string().optional(),
            coverArt: z.string().optional(),
            id: z.string(),
...
export var SubsonicExtensions;
(function (SubsonicExtensions) {
    SubsonicExtensions["FORM_POST"] = "formPost";
    SubsonicExtensions["INDEX_BASED_QUEUE"] = "indexBasedQueue";
    SubsonicExtensions["SONG_LYRICS"] = "songLyrics";
    SubsonicExtensions["TRANSCODE_OFFSET"] = "transcodeOffset";
    SubsonicExtensions["TRANSCODING"] = "transcoding";
...
export var AlbumListSortType;
(function (AlbumListSortType) {
    AlbumListSortType["ALPHABETICAL_BY_ARTIST"] = "alphabeticalByArtist";
    AlbumListSortType["ALPHABETICAL_BY_NAME"] = "alphabeticalByName";
    AlbumListSortType["BY_GENRE"] = "byGenre";
    AlbumListSortType["BY_YEAR"] = "byYear";
    AlbumListSortType["FREQUENT"] = "frequent";
    AlbumListSortType["NEWEST"] = "newest";
    AlbumListSortType["RANDOM"] = "random";
    AlbumListSortType["RECENT"] = "recent";
    AlbumListSortType["STARRED"] = "starred";
