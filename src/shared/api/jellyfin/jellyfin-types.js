import { z } from 'zod';
export var JFAlbumArtistListSort;
(function (JFAlbumArtistListSort) {
    JFAlbumArtistListSort["ALBUM"] = "Album,SortName";
    JFAlbumArtistListSort["DURATION"] = "Runtime,AlbumArtist,Album,SortName";
    JFAlbumArtistListSort["NAME"] = "SortName,Name";
    JFAlbumArtistListSort["RANDOM"] = "Random,SortName";
    JFAlbumArtistListSort["RECENTLY_ADDED"] = "DateCreated,SortName";
    JFAlbumArtistListSort["RELEASE_DATE"] = "PremiereDate,AlbumArtist,Album,SortName";
})(JFAlbumArtistListSort || (JFAlbumArtistListSort = {}));
export var JFAlbumListSort;
(function (JFAlbumListSort) {
    JFAlbumListSort["ALBUM_ARTIST"] = "AlbumArtist,SortName";
    JFAlbumListSort["COMMUNITY_RATING"] = "CommunityRating,SortName";
    JFAlbumListSort["CRITIC_RATING"] = "CriticRating,SortName";
    JFAlbumListSort["NAME"] = "SortName";
    JFAlbumListSort["PLAY_COUNT"] = "PlayCount";
    JFAlbumListSort["RANDOM"] = "Random,SortName";
    JFAlbumListSort["RECENTLY_ADDED"] = "DateCreated,SortName";
    JFAlbumListSort["RELEASE_DATE"] = "ProductionYear,PremiereDate,SortName";
})(JFAlbumListSort || (JFAlbumListSort = {}));
export var JFArtistListSort;
(function (JFArtistListSort) {
    JFArtistListSort["ALBUM"] = "Album,SortName";
    JFArtistListSort["DURATION"] = "Runtime,AlbumArtist,Album,SortName";
    JFArtistListSort["NAME"] = "SortName,Name";
    JFArtistListSort["RANDOM"] = "Random,SortName";
    JFArtistListSort["RECENTLY_ADDED"] = "DateCreated,SortName";
    JFArtistListSort["RELEASE_DATE"] = "PremiereDate,AlbumArtist,Album,SortName";
})(JFArtistListSort || (JFArtistListSort = {}));
export var JFGenreListSort;
(function (JFGenreListSort) {
    JFGenreListSort["NAME"] = "SortName";
})(JFGenreListSort || (JFGenreListSort = {}));
export var JFPlaylistListSort;
(function (JFPlaylistListSort) {
    JFPlaylistListSort["ALBUM_ARTIST"] = "AlbumArtist,SortName";
    JFPlaylistListSort["DURATION"] = "Runtime";
    JFPlaylistListSort["NAME"] = "SortName";
    JFPlaylistListSort["RECENTLY_ADDED"] = "DateCreated,SortName";
    JFPlaylistListSort["SONG_COUNT"] = "ChildCount";
})(JFPlaylistListSort || (JFPlaylistListSort = {}));
export var JFSongListSort;
(function (JFSongListSort) {
    JFSongListSort["ALBUM"] = "Album,SortName";
    JFSongListSort["ALBUM_ARTIST"] = "AlbumArtist,Album,SortName";
    JFSongListSort["ARTIST"] = "Artist,Album,SortName";
    JFSongListSort["COMMUNITY_RATING"] = "CommunityRating,SortName";
    JFSongListSort["DURATION"] = "Runtime,AlbumArtist,Album,SortName";
    JFSongListSort["NAME"] = "Name";
    JFSongListSort["PLAY_COUNT"] = "PlayCount,SortName";
    JFSongListSort["RANDOM"] = "Random,SortName";
    JFSongListSort["RECENTLY_ADDED"] = "DateCreated,SortName";
    JFSongListSort["RECENTLY_PLAYED"] = "DatePlayed,SortName";
    JFSongListSort["RELEASE_DATE"] = "PremiereDate,AlbumArtist,Album,SortName";
})(JFSongListSort || (JFSongListSort = {}));
export var JFSortOrder;
(function (JFSortOrder) {
    JFSortOrder["ASC"] = "Ascending";
    JFSortOrder["DESC"] = "Descending";
...
const genreListParameters = paginationParameters.merge(baseParameters.extend({
    SearchTerm: z.string().optional(),
...
const playlistListParameters = paginationParameters.merge(baseParameters.extend({
...
const albumListParameters = paginationParameters.merge(baseParameters.extend({
...
const albumArtistListParameters = paginationParameters.merge(baseParameters.extend({
    Filters: z.string().optional(),
    Genres: z.string().optional(),
...
const songListParameters = paginationParameters.merge(baseParameters.extend({
    AlbumArtistIds: z.string().optional(),
...
export var JellyfinExtensions;
(function (JellyfinExtensions) {
    JellyfinExtensions["SONG_LYRICS"] = "songLyrics";
})(JellyfinExtensions || (JellyfinExtensions = {}));
...
const saveQueueParameters = scrobbleParameters.merge(z.object({
    NowPlayingQueue: z.array(queueItem),
    PlaylistItemId: z.string().optional(),
}));
const getQueueParameters = z.object({});
const getSessions = z.array(sessionInfo.merge(z.object({
    PlaylistItemId: z.string().optional(),
})));
const studioListParameters = paginationParameters.merge(baseParameters.extend({
