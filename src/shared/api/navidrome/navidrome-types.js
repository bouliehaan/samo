...
import { z } from 'zod';
export var NDAlbumArtistListSort;
(function (NDAlbumArtistListSort) {
    NDAlbumArtistListSort["ALBUM_COUNT"] = "albumCount";
    NDAlbumArtistListSort["FAVORITED"] = "starred_at";
    NDAlbumArtistListSort["NAME"] = "name";
    NDAlbumArtistListSort["PLAY_COUNT"] = "playCount";
    NDAlbumArtistListSort["RATING"] = "rating";
    NDAlbumArtistListSort["SONG_COUNT"] = "songCount";
})(NDAlbumArtistListSort || (NDAlbumArtistListSort = {}));
export var NDAlbumListSort;
(function (NDAlbumListSort) {
    NDAlbumListSort["ALBUM_ARTIST"] = "album_artist";
    NDAlbumListSort["ARTIST"] = "artist";
    NDAlbumListSort["DURATION"] = "duration";
    NDAlbumListSort["EXPLICIT_STATUS"] = "explicitStatus";
    NDAlbumListSort["NAME"] = "name";
    NDAlbumListSort["PLAY_COUNT"] = "play_count";
    NDAlbumListSort["PLAY_DATE"] = "play_date";
    NDAlbumListSort["RANDOM"] = "random";
    NDAlbumListSort["RATING"] = "rating";
    NDAlbumListSort["RECENTLY_ADDED"] = "recently_added";
    NDAlbumListSort["SONG_COUNT"] = "songCount";
    NDAlbumListSort["STARRED"] = "starred_at";
    NDAlbumListSort["YEAR"] = "max_year";
})(NDAlbumListSort || (NDAlbumListSort = {}));
export var NDGenreListSort;
(function (NDGenreListSort) {
    NDGenreListSort["NAME"] = "name";
})(NDGenreListSort || (NDGenreListSort = {}));
export var NDPlaylistListSort;
(function (NDPlaylistListSort) {
    NDPlaylistListSort["DURATION"] = "duration";
    NDPlaylistListSort["NAME"] = "name";
    NDPlaylistListSort["OWNER"] = "owner_name";
    NDPlaylistListSort["PUBLIC"] = "public";
    NDPlaylistListSort["SONG_COUNT"] = "songCount";
    NDPlaylistListSort["UPDATED_AT"] = "updatedAt";
})(NDPlaylistListSort || (NDPlaylistListSort = {}));
export var NDSongListSort;
(function (NDSongListSort) {
    NDSongListSort["ALBUM"] = "album";
    NDSongListSort["ALBUM_ARTIST"] = "order_album_artist_name";
    NDSongListSort["ALBUM_SONGS"] = "album";
    NDSongListSort["ARTIST"] = "artist";
    NDSongListSort["BPM"] = "bpm";
    NDSongListSort["CHANNELS"] = "channels";
    NDSongListSort["COMMENT"] = "comment";
    NDSongListSort["DURATION"] = "duration";
    NDSongListSort["EXPLICIT_STATUS"] = "explicitStatus";
    NDSongListSort["FAVORITED"] = "starred_at";
    NDSongListSort["GENRE"] = "genre";
    NDSongListSort["ID"] = "id";
    NDSongListSort["PLAY_COUNT"] = "playCount";
    NDSongListSort["PLAY_DATE"] = "playDate";
    NDSongListSort["RANDOM"] = "random";
    NDSongListSort["RATING"] = "rating";
    NDSongListSort["RECENTLY_ADDED"] = "createdAt";
    NDSongListSort["TITLE"] = "title";
    NDSongListSort["TRACK"] = "track";
    NDSongListSort["YEAR"] = "year";
})(NDSongListSort || (NDSongListSort = {}));
export var NDSortOrder;
(function (NDSortOrder) {
    NDSortOrder["ASC"] = "ASC";
    NDSortOrder["DESC"] = "DESC";
...
export const NDSongQueryFieldsLabelMap = NDSongQueryFields.reduce((acc, field) => {
...
export var NDUserListSort;
(function (NDUserListSort) {
    NDUserListSort["NAME"] = "name";
...
export var NDTagListSort;
(function (NDTagListSort) {
    NDTagListSort["TAG_VALUE"] = "tagValue";
})(NDTagListSort || (NDTagListSort = {}));
...
export var NDRadioListSort;
(function (NDRadioListSort) {
    NDRadioListSort["NAME"] = "name";
})(NDRadioListSort || (NDRadioListSort = {}));
