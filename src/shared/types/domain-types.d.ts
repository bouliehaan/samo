...
import { type ServerListItemCore, type ServerListItemWithCredentialCore, ServerType } from '@samo/core/server';
...
export type AnyLibraryItems = Album[] | AlbumArtist[] | Artist[] | Playlist[] | QueueSong[] | Song[];
...
export declare const sortOrderMap: SortOrderMap;
...
export declare enum GenreListSort {
    NAME = "name"
}
...
export declare enum TagListSort {
    NAME = "name"
}
export type Album = {
...
export type FolderArgs = BaseEndpointArgs & {
    query: FolderQuery;
};
...
export type GenreListArgs = BaseEndpointArgs & {
...
export declare const genreListSortMap: GenreListSortMap;
type TagListSortMap = {
...
export declare const tagListSortMap: TagListSortMap;
export declare enum AlbumListSort {
...
export type AlbumListArgs = BaseEndpointArgs & {
    query: AlbumListQuery;
};
export type AlbumListCountArgs = BaseEndpointArgs & {
...
export declare const albumListSortMap: AlbumListSortMap;
export declare enum SongListSort {
    ALBUM = "album",
    ALBUM_ARTIST = "albumArtist",
    ARTIST = "artist",
    BPM = "bpm",
...
export type AlbumDetailArgs = BaseEndpointArgs & {
...
export type SongListCountArgs = BaseEndpointArgs & {
    query: ListCountQuery<SongListQuery>;
};
...
export declare const songListSortMap: SongListSortMap;
export declare enum AlbumArtistListSort {
    ALBUM = "album",
...
export type AlbumArtistListArgs = BaseEndpointArgs & {
...
export type SongDetailArgs = BaseEndpointArgs & {
...
export declare const albumArtistListSortMap: AlbumArtistListSortMap;
export declare enum ArtistListSort {
    ALBUM = "album",
    ALBUM_COUNT = "albumCount",
    DURATION = "duration",
    FAVORITED = "favorited",
...
export type AlbumArtistDetailArgs = BaseEndpointArgs & {
    query: AlbumArtistDetailQuery;
};
export type AlbumArtistDetailQuery = {
    id: string;
};
export type AlbumArtistDetailResponse = AlbumArtist | null;
export type AlbumArtistInfoArgs = BaseEndpointArgs & {
    query: AlbumArtistInfoQuery;
};
export type AlbumArtistInfoQuery = {
    id: string;
    limit?: number;
};
...
export type ArtistListArgs = BaseEndpointArgs & {
    query: ArtistListQuery;
};
export type ArtistListCountArgs = BaseEndpointArgs & {
    query: ListCountQuery<ArtistListQuery>;
};
...
export declare const artistListSortMap: ArtistListSortMap;
export declare enum PlaylistListSort {
    DURATION = "duration",
    NAME = "name",
    OWNER = "owner",
    PUBLIC = "public",
...
export declare enum RadioListSort {
    ID = "id",
    NAME = "name"
}
...
export type CreatePlaylistArgs = BaseEndpointArgs & {
...
export type CreatePlaylistResponse = undefined | {
    id: string;
};
...
export type DeletePlaylistQuery = {
    id: string;
};
export type DeletePlaylistResponse = null | undefined;
export type FavoriteArgs = BaseEndpointArgs & {
    query: FavoriteQuery;
};
...
export type PlaylistListArgs = BaseEndpointArgs & {
    query: PlaylistListQuery;
};
export type PlaylistListCountArgs = BaseEndpointArgs & {
    query: ListCountQuery<PlaylistListQuery>;
};
...
export type SetRatingArgs = BaseEndpointArgs & {
    query: RatingQuery;
};
export type ShareItemArgs = BaseEndpointArgs & {
    body: ShareItemBody;
};
...
export type ShareItemResponse = undefined | {
    id: string;
};
...
export declare const playlistListSortMap: PlaylistListSortMap;
export declare enum UserListSort {
    NAME = "name"
}
...
export type PlaylistDetailArgs = BaseEndpointArgs & {
...
export type PlaylistSongListArgs = BaseEndpointArgs & {
...
export type UserListArgs = BaseEndpointArgs & {
    query: UserListQuery;
};
...
export declare const userListSortMap: UserListSortMap;
export declare enum Played {
    All = "all",
    Never = "never",
    Played = "played"
}
export type ArtistInfoArgs = BaseEndpointArgs & {
...
export type TopSongListArgs = BaseEndpointArgs & {
    query: TopSongListQuery;
};
...
export declare const instanceOfCancellationError: (error: any) => boolean;
...
export type ControllerEndpoint = {
    ...
    createInternetRadioStation: (args: CreateInternetRadioStationArgs) => Promise<CreateInternetRadioStationResponse>;
    createPlaylist: (args: CreatePlaylistArgs) => Promise<CreatePlaylistResponse>;
    deleteArtistImage?: (args: DeleteArtistImageArgs) => Promise<DeleteArtistImageResponse>;
    deleteFavorite: (args: FavoriteArgs) => Promise<FavoriteResponse>;
    deleteInternetRadioStation: (args: DeleteInternetRadioStationArgs) => Promise<DeleteInternetRadioStationResponse>;
    deleteInternetRadioStationImage?: (args: DeleteInternetRadioStationImageArgs) => Promise<DeleteInternetRadioStationImageResponse>;
    ...
    getInternetRadioStations: (args: GetInternetRadioStationsArgs) => Promise<GetInternetRadioStationsResponse>;
    ...
    getRoles: (args: BaseEndpointArgs) => Promise<Array<string | {
        label: string;
        value: string;
    }>>;
    ...
    updateInternetRadioStation: (args: UpdateInternetRadioStationArgs) => Promise<UpdateInternetRadioStationResponse>;
    updatePlaylist: (args: UpdatePlaylistArgs) => Promise<UpdatePlaylistResponse>;
    uploadArtistImage?: (args: UploadArtistImageArgs) => Promise<UploadArtistImageResponse>;
    uploadInternetRadioStationImage?: (args: UploadInternetRadioStationImageArgs) => Promise<UploadInternetRadioStationImageResponse>;
...
export type InternalControllerEndpoint = {
    addToPlaylist: (args: ReplaceApiClientProps<AddToPlaylistArgs>) => Promise<AddToPlaylistResponse>;
    authenticate: (url: string, body: {
        legacy?: boolean;
        password: string;
        username: string;
    ...
    createInternetRadioStation: (args: ReplaceApiClientProps<CreateInternetRadioStationArgs>) => Promise<CreateInternetRadioStationResponse>;
    createPlaylist: (args: ReplaceApiClientProps<CreatePlaylistArgs>) => Promise<CreatePlaylistResponse>;
    deleteArtistImage?: (args: ReplaceApiClientProps<DeleteArtistImageArgs>) => Promise<DeleteArtistImageResponse>;
    deleteFavorite: (args: ReplaceApiClientProps<FavoriteArgs>) => Promise<FavoriteResponse>;
    deleteInternetRadioStation: (args: ReplaceApiClientProps<DeleteInternetRadioStationArgs>) => Promise<DeleteInternetRadioStationResponse>;
    deleteInternetRadioStationImage?: (args: ReplaceApiClientProps<DeleteInternetRadioStationImageArgs>) => Promise<DeleteInternetRadioStationImageResponse>;
    deletePlaylist: (args: ReplaceApiClientProps<DeletePlaylistArgs>) => Promise<DeletePlaylistResponse>;
    deletePlaylistImage?: (args: ReplaceApiClientProps<DeletePlaylistImageArgs>) => Promise<DeletePlaylistImageResponse>;
    getAlbumArtistDetail: (args: ReplaceApiClientProps<AlbumArtistDetailArgs>) => Promise<AlbumArtistDetailResponse>;
    getAlbumArtistInfo?: (args: ReplaceApiClientProps<AlbumArtistInfoArgs>) => Promise<AlbumArtistInfoResponse | null>;
    getAlbumArtistList: (args: ReplaceApiClientProps<AlbumArtistListArgs>) => Promise<AlbumArtistListResponse>;
    getAlbumArtistListCount: (args: ReplaceApiClientProps<AlbumArtistListCountArgs>) => Promise<number>;
    ...
    getInternetRadioStations: (args: ReplaceApiClientProps<GetInternetRadioStationsArgs>) => Promise<GetInternetRadioStationsResponse>;
    getLyrics?: (args: ReplaceApiClientProps<LyricsArgs>) => Promise<LyricsResponse>;
    getMusicFolderList: (args: ReplaceApiClientProps<MusicFolderListArgs>) => Promise<MusicFolderListResponse>;
    getPlaylistDetail: (args: ReplaceApiClientProps<PlaylistDetailArgs>) => Promise<PlaylistDetailResponse>;
    getPlaylistList: (args: ReplaceApiClientProps<PlaylistListArgs>) => Promise<PlaylistListResponse>;
    getPlaylistListCount: (args: ReplaceApiClientProps<PlaylistListCountArgs>) => Promise<number>;
    getPlaylistSongList: (args: ReplaceApiClientProps<PlaylistSongListArgs>) => Promise<SongListResponse>;
    getPlayQueue: (args: ReplaceApiClientProps<GetQueueArgs>) => Promise<GetQueueResponse>;
    getRandomSongList: (args: ReplaceApiClientProps<RandomSongListArgs>) => Promise<SongListResponse>;
    getRoles: (args: ReplaceApiClientProps<BaseEndpointArgs>) => Promise<Array<string | {
        label: string;
        value: string;
    }>>;
    ...
    getStructuredLyrics?: (args: ReplaceApiClientProps<StructuredLyricsArgs>) => Promise<StructuredLyric[]>;
    ...
    removeFromPlaylist: (args: ReplaceApiClientProps<RemoveFromPlaylistArgs>) => Promise<RemoveFromPlaylistResponse>;
    replacePlaylist: (args: ReplaceApiClientProps<ReplacePlaylistArgs>) => Promise<ReplacePlaylistResponse>;
    ...
    setPlaylistSongs: (args: ReplaceApiClientProps<SetPlaylistSongsArgs>) => Promise<SetPlaylistSongsResponse>;
    ...
    updateInternetRadioStation: (args: ReplaceApiClientProps<UpdateInternetRadioStationArgs>) => Promise<UpdateInternetRadioStationResponse>;
    updatePlaylist: (args: ReplaceApiClientProps<UpdatePlaylistArgs>) => Promise<UpdatePlaylistResponse>;
    uploadArtistImage?: (args: ReplaceApiClientProps<UploadArtistImageArgs>) => Promise<UploadArtistImageResponse>;
    uploadInternetRadioStationImage?: (args: ReplaceApiClientProps<UploadInternetRadioStationImageArgs>) => Promise<UploadInternetRadioStationImageResponse>;
    uploadPlaylistImage?: (args: ReplaceApiClientProps<UploadPlaylistImageArgs>) => Promise<UploadPlaylistImageResponse>;
};
...
export type LyricsOverride = Omit<FullLyricsMetadata, 'lyrics'> & {
    id: string;
};
...
export type SetPlaylistSongsArgs = BaseEndpointArgs & {
    body: SetPlaylistSongsQuery;
};
...
export type UserInfoArgs = BaseEndpointArgs & {
    query: UserInfoQuery;
};
