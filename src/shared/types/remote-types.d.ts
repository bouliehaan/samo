...
export type ClientEvent = ClientAuth | ClientFavorite | ClientPosition | ClientRating | ClientSimpleEvent | ClientVolume;
...
export type ServerEvent = ServerError | ServerFavorite | ServerPlayStatus | ServerPosition | ServerProxy | ServerRating | ServerRepeat | ServerShuffle | ServerSong | ServerState | ServerVolume;
