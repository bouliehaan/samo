...
export const MultiSelect = ({ classNames, maxWidth, variant = 'default', width, ...props }) => {
    ...
    return (_jsx(MantineMultiSelect, { classNames: mergedClassNames, clearButtonProps: defaultClearButtonProps, style: style, variant: variant, withCheckIcon: false, ...props }));
};
