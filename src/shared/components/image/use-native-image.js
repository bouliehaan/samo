...
export function useNativeImage({ enabled, fetchPriority, onFetchError, request, }) {
    const abortControllerRef = useRef(null);
    const loadedRequestSignatureRef = useRef(null);
    ...
    useEffect(() => {
        ...
        if (!enabled) {
            abortCurrentRequest();
            setState((currentState) => currentState.displaySrc
