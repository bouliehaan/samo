...
const ListenBrainzLogoIcon = forwardRef(({ className, size, style, ...props }, ref) => (_jsx("img", { alt: "ListenBrainz", className: className, ref: ref, src: listenbrainzLogoIcon, style: logoImgStyle(size) ?? style, ...props })));
const SpotifyLogoIcon = forwardRef(({ className, size, style, ...props }, ref) => (_jsx("img", { alt: "Spotify", className: className, ref: ref, src: spotifyLogoIcon, style: logoImgStyle(size) ?? style, ...props })));
const MusicBrainzLogoIcon = forwardRef(({ className, size, style, ...props }, ref) => (_jsx("img", { alt: "MusicBrainz", className: className, ref: ref, src: musicbrainzLogoIcon, style: logoImgStyle(size) ?? style, ...props })));
const QobuzLogoIcon = forwardRef(({ className, size, style, ...props }, ref) => (_jsx("img", { alt: "Qobuz", className: className, ref: ref, src: qobuzLogoIcon, style: logoImgStyle(size) ?? style, ...props })));
const LastfmLogoIcon = forwardRef(({ className, size, style, ...props }, ref) => (_jsx("img", { alt: "Last.fm", className: className, ref: ref, src: lastfmLogoIcon, style: logoImgStyle(size) ?? style, ...props })));
...
const _Icon = forwardRef((props, ref) => {
    ...
    return (_jsx(IconComponent, { className: classNames, fill: fill, ref: ref, size: isPredefinedSize(size) ? undefined : size }));
});
