...
export default class MenuBuilder {
    ...
    buildDarwinTemplate({ accelerators, playbackStatus = PlayerStatus.PAUSED, privateMode = false, repeatMode = PlayerRepeat.NONE, shuffleEnabled = false, sidebarCollapsed = false, } = {}) {
        ...
        const subMenuHelp = {
            ...
            submenu: [
                {
                    click() {
                        shell.openExternal('https://github.com/bouliehaan/samo');
                    },
                    label: 'Learn More',
                },
                {
                    click() {
                        shell.openExternal('https://github.com/bouliehaan/samo?tab=readme-ov-file#getting-started');
                    },
                    label: 'Documentation',
                },
                {
                    click() {
                        shell.openExternal('https://github.com/bouliehaan/samo/discussions');
                    },
