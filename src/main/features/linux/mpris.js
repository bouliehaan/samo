...
ipcMain.on('update-position', (_event, arg) => {
...
ipcMain.on('update-song', (_event, song, imageUrl) => {
    try {
        ...
        mprisPlayer.metadata = {
            ...
            'xesam:useCount': song.playCount !== null && song.playCount !== undefined ? song.playCount : null,
