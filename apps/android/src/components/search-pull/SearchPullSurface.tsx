...
export const SearchPullSurface = memo(function SearchPullSurface() {
     ...
     * the second half of the mis-seating bug above — one bug put you in the
     * state, the other made it a room with no door.
     *
    ...
    return (
        <>
            {/* Tap the dimmed page to put search away — the same animated
                retract every other dismissal funnels through. Drag it to carry
                the surface on in either direction (see `scrimGesture`). */}
            <Reanimated.View
