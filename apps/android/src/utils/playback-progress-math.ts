...
export const getPlaybackProgressSeconds = (
...
export const getPlayerPositionMsForPlaybackProgress = (
 ...
 */
export const buildPlaybackProgressContextFromPlayable = (
    item: MobilePlayableAudio,
    serverConnection: ServerAuthenticationResult | null,
): PlaybackProgressContext | null => {
    ...
    if (item.source === 'audiobook' && authentication) {
        ...
        return {
            authentication,
            // Progress is reported against the BOOK, and getPlaybackProgressSeconds
