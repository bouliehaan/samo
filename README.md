...
- [`docs/NAMING.md`](docs/NAMING.md) — the name is `samo`, lowercase, everywhere a person reads it. Where that has been broken before, and the one exception for code identifiers.
